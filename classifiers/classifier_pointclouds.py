...
class CLASSIFIER:
    # train_Y is interger 
    def __init__(self, _train_X, _train_Y, data_loader, _nclass, _cuda, _lr=0.001, _beta1=0.5, _nepoch=20, _batch_size=100, generalized=True, netMap=None, dec_size=4096, dec_hidden_size=2048):
    ...
    def compute_dec_out(self, test_X, new_size):
        ...
        for i in range(0, ntest, self.batch_size):
            ...
            if self.cuda:
                ...
                inputX = Variable(test_X[start:end], volatile=True)
            feat1 = self.netMap(inputX)
            feat2 = self.netMap.getLayersOutEmbed()
