...
parser.add_argument('--point_embedding', default='PointNet')
...
parser.add_argument('--neh', type=int, default=2048, help='size of the hidden units in encoder')
...
parser.add_argument('--nclass_all', type=int, default=40, help='number of all classes')
parser.add_argument('--nclass_seen', type=int, default=30, help='number of all classes')
...
###
parser.add_argument('--embedSize', type=int, default=2048, help='')
parser.add_argument('--outzSize', type=int, default=512, help='')
...
parser.add_argument('--ins_weight', type=float, default=1.0, help='weight of the classification loss when learning G')
parser.add_argument('--cls_weight', type=float, default=1.0, help='weight of the score function when learning G')
